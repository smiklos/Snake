...
public class ThreadsController extends Thread {
	DataOfSquare[][] Squares = new DataOfSquare[20][20];
	Tuple headSnakePos;
	int sizeSnake = 3;
	long speed = 50;
	...
	ThreadsController(Tuple positionDepart, DataOfSquare[][] grid) {
		// Get all the threads
		Squares = grid;
	...
	private void spawnFood(Tuple foodPositionIn) {
		Squares[foodPositionIn.x][foodPositionIn.y].lightMeUp(1);
	}
